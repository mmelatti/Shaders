Shader "unityCookie/tut/beginner/2 - Ambient" {
	Properties {
	...
	SubShader {
		Pass {
			...
			vertexOutput vert(vertexInput v) {
				...
				float3 diffuseReflection = atten * _LightColor0.xyz * max( 0.0, dot(normalDirection, lightDirection) ); //new one allows multiple light sources.
				...
				o.col = float4(lightFinal * _Color, 1.0); //output color
