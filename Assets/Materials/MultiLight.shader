...
Shader "unityCookie/tut/beginner/MultiLight - 1" {
	...
	SubShader {
		...
		Pass{
			...
			Blend One One //blend over the last pass, this can be in the first pass and the shader will blender over behind objects
			CGPROGRAM
			#pragma vertex vert
			#pragma fragment frag
